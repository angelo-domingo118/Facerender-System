            ...
            @auth
                <div class="ms-3 relative" x-data="{ userOpen: false }" @click.away="userOpen = false">
                    ...
                    <div x-show="userOpen" 
                        ...
                        <!-- Dashboard Link -->
                        <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2.5 text-sm text-white hover:bg-[#34495E] transition group">
        ...
        <div class="pt-4 pb-1 border-t border-gray-600">
            ...
            @auth
                <div class="mt-3 space-y-1 px-4">
                    <!-- Account Management -->
                    <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="text-white hover:text-[#3498DB]">
                        {{ __('Dashboard') }}
